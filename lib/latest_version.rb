...
module LatestVersion
  LIBRARIES = {
    ...
    rails: lambda {
      Find.call(url: 'https://rubyonrails.org/', regex: /Latest version &mdash; Rails ([\d\.]+)/)
    },
    ruby: lambda {
      Find.call(url: 'https://www.ruby-lang.org/en/downloads/', regex: /current stable version is (\d+\.\d+\.\d+)\./)
    },
  }.freeze
